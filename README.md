...
>  pip install pytoml psutil cherrypy==3.2.2;cd ../../
...
6. Open browser to [http://localhost:8580](http://localhost:8580) to access spc and active the application Mendel's Accountant.
